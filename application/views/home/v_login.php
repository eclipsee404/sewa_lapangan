    ...
    <div class="wrapper fadeInDown">
        <div id="formContent">
            ...
            <div class="fadeIn first">
                <img src="<?= base_url() ?>assets/img/logo/logo.png" id="icon" alt="User Icon" />
            </div>


            <!-- Login Form -->
            <form action="<?= base_url(); ?>/auth/login" method="post">
                <input type="text" id="login" class="fadeIn second" name="user_nama" placeholder="Masukan username"
                    autocomplete="off">
                <input type="password" id="password" class="fadeIn third" name="user_password"
